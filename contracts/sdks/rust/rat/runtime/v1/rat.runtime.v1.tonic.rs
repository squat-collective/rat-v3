...
pub mod runtime_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("rat.runtime.v1.RuntimeService", "Execute"));
...
pub mod runtime_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/rat.runtime.v1.RuntimeService/Execute" => {
                    ...
                    struct ExecuteSvc<T: RuntimeService>(pub Arc<T>);
                    impl<
                        T: RuntimeService,
                    ...
                    for ExecuteSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as RuntimeService>::execute(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "rat.runtime.v1.RuntimeService";
