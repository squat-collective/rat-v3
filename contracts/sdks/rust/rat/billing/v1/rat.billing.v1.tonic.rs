...
pub mod billing_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn record(
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("rat.billing.v1.BillingService", "Record"));
...
pub mod billing_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/rat.billing.v1.BillingService/Record" => {
                    ...
                    struct RecordSvc<T: BillingService>(pub Arc<T>);
                    impl<
                        T: BillingService,
                    ...
                    for RecordSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as BillingService>::record(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "rat.billing.v1.BillingService";
