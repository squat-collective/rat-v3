...
pub mod tenancy_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn decide(
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("rat.tenancy.v1.TenancyService", "Decide"));
...
pub mod tenancy_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/rat.tenancy.v1.TenancyService/Decide" => {
                    ...
                    struct DecideSvc<T: TenancyService>(pub Arc<T>);
                    impl<
                        T: TenancyService,
                    ...
                    for DecideSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as TenancyService>::decide(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "rat.tenancy.v1.TenancyService";
