...
pub mod storage_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn vend_credentials(
            &mut self,
            request: impl tonic::IntoRequest<super::VendCredentialsRequest>,
        ) -> std::result::Result<
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("rat.storage.v1.StorageService", "VendCredentials"),
                );
...
pub mod storage_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/rat.storage.v1.StorageService/VendCredentials" => {
                    ...
                    struct VendCredentialsSvc<T: StorageService>(pub Arc<T>);
                    impl<
                        T: StorageService,
                    > tonic::server::UnaryService<super::VendCredentialsRequest>
                    for VendCredentialsSvc<T> {
                        type Response = super::VendCredentialsResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as StorageService>::vend_credentials(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    pub const SERVICE_NAME: &str = "rat.storage.v1.StorageService";
