...
pub mod identity_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("rat.identity.v1.IdentityService", "Authenticate"),
                );
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("rat.identity.v1.IdentityService", "Authorize"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod identity_service_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/rat.identity.v1.IdentityService/Authorize" => {
                    #[allow(non_camel_case_types)]
                    struct AuthorizeSvc<T: IdentityService>(pub Arc<T>);
                    impl<
                        T: IdentityService,
                    ...
                    for AuthorizeSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as IdentityService>::authorize(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "rat.identity.v1.IdentityService";
