...
pub mod scheduler_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("rat.scheduler.v1.SchedulerService", "Schedule"),
                );
        ...
        pub async fn cancel(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("rat.scheduler.v1.SchedulerService", "Cancel"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn watch_due(
            &mut self,
            request: impl tonic::IntoRequest<super::WatchDueRequest>,
        ) -> std::result::Result<
            tonic::Response<tonic::codec::Streaming<super::WatchDueResponse>>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("rat.scheduler.v1.SchedulerService", "WatchDue"),
                );
...
pub mod scheduler_service_server {
    ...
    pub trait SchedulerService: std::marker::Send + std::marker::Sync + 'static {
        ...
        /// Server streaming response type for the WatchDue method.
        type WatchDueStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::WatchDueResponse, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        async fn watch_due(
            &self,
            request: tonic::Request<super::WatchDueRequest>,
        ) -> std::result::Result<tonic::Response<Self::WatchDueStream>, tonic::Status>;
    }
    #[derive(Debug)]
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/rat.scheduler.v1.SchedulerService/Cancel" => {
                    #[allow(non_camel_case_types)]
                    struct CancelSvc<T: SchedulerService>(pub Arc<T>);
                    impl<
                        T: SchedulerService,
                    ...
                    for CancelSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SchedulerService>::cancel(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/rat.scheduler.v1.SchedulerService/WatchDue" => {
                    #[allow(non_camel_case_types)]
                    struct WatchDueSvc<T: SchedulerService>(pub Arc<T>);
                    impl<
                        T: SchedulerService,
                    > tonic::server::ServerStreamingService<super::WatchDueRequest>
                    for WatchDueSvc<T> {
                        type Response = super::WatchDueResponse;
                        type ResponseStream = T::WatchDueStream;
                        type Future = BoxFuture<
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SchedulerService>::watch_due(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "rat.scheduler.v1.SchedulerService";
