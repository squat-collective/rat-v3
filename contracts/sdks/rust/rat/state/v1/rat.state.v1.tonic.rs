...
pub mod state_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get(
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("rat.state.v1.StateService", "Get"));
        ...
        pub async fn put(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("rat.state.v1.StateService", "Put"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn list(
            &mut self,
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("rat.state.v1.StateService", "List"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn delete(
            &mut self,
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("rat.state.v1.StateService", "Delete"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn watch(
            &mut self,
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("rat.state.v1.StateService", "Watch"));
...
pub mod state_service_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/rat.state.v1.StateService/List" => {
                    #[allow(non_camel_case_types)]
                    struct ListSvc<T: StateService>(pub Arc<T>);
                    impl<T: StateService> tonic::server::UnaryService<super::ListRequest>
                    for ListSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as StateService>::list(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/rat.state.v1.StateService/Delete" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteSvc<T: StateService>(pub Arc<T>);
                    impl<
                        T: StateService,
                    ...
                    for DeleteSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as StateService>::delete(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "rat.state.v1.StateService";
