...
pub mod control_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("rat.core.v1.ControlService", "RegisterPlugin"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn deregister_plugin(
            &mut self,
            request: impl tonic::IntoRequest<super::DeregisterPluginRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DeregisterPluginResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("rat.core.v1.ControlService", "DeregisterPlugin"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("rat.core.v1.ControlService", "ListPlugins"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod control_service_server {
    ...
    pub trait ControlService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn deregister_plugin(
            &self,
            request: tonic::Request<super::DeregisterPluginRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DeregisterPluginResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/rat.core.v1.ControlService/RegisterPlugin" => {
                    ...
                    struct RegisterPluginSvc<T: ControlService>(pub Arc<T>);
                    impl<
                        T: ControlService,
                    ...
                    for RegisterPluginSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as ControlService>::register_plugin(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/rat.core.v1.ControlService/DeregisterPlugin" => {
                    #[allow(non_camel_case_types)]
                    struct DeregisterPluginSvc<T: ControlService>(pub Arc<T>);
                    impl<
                        T: ControlService,
                    > tonic::server::UnaryService<super::DeregisterPluginRequest>
                    for DeregisterPluginSvc<T> {
                        type Response = super::DeregisterPluginResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ControlService>::deregister_plugin(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeregisterPluginSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/rat.core.v1.ControlService/ListPlugins" => {
                    #[allow(non_camel_case_types)]
                    struct ListPluginsSvc<T: ControlService>(pub Arc<T>);
                    impl<
                        T: ControlService,
                    ...
                    for ListPluginsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ControlService>::list_plugins(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "rat.core.v1.ControlService";
    impl<T> tonic::server::NamedService for ControlServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
pub mod capability_invoke_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::http::Uri;
    #[derive(Debug, Clone)]
    pub struct CapabilityInvokeServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl CapabilityInvokeServiceClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
    ...
    impl<T> CapabilityInvokeServiceClient<T>
    where
        T: tonic::client::GrpcService<tonic::body::Body>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + std::marker::Send + 'static,
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> CapabilityInvokeServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            CapabilityInvokeServiceClient::new(
        ...
        pub async fn invoke(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("rat.core.v1.CapabilityInvokeService", "Invoke"),
                );
            self.inner.unary(req, path, codec).await
        }
...
/// Generated server implementations.
pub mod capability_invoke_service_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with CapabilityInvokeServiceServer.
    #[async_trait]
    pub trait CapabilityInvokeService: std::marker::Send + std::marker::Sync + 'static {
        async fn invoke(
            &self,
    ...
    impl<T> CapabilityInvokeServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    for CapabilityInvokeServiceServer<T>
    where
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/rat.core.v1.CapabilityInvokeService/Invoke" => {
                    #[allow(non_camel_case_types)]
                    struct InvokeSvc<T: CapabilityInvokeService>(pub Arc<T>);
                    impl<
                        T: CapabilityInvokeService,
                    ...
                    for InvokeSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CapabilityInvokeService>::invoke(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    impl<T> Clone for CapabilityInvokeServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "rat.core.v1.CapabilityInvokeService";
    impl<T> tonic::server::NamedService for CapabilityInvokeServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
