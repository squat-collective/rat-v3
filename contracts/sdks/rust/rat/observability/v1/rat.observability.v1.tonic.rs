...
pub mod observability_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn ingest(
            &mut self,
            request: impl tonic::IntoStreamingRequest<Message = super::IngestRequest>,
        ) -> std::result::Result<
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "rat.observability.v1.ObservabilityService",
                        "Ingest",
                    ),
                );
...
pub mod observability_service_server {
    ...
    pub trait ObservabilityService: std::marker::Send + std::marker::Sync + 'static {
        /// Server streaming response type for the Ingest method.
        type IngestStream: tonic::codegen::tokio_stream::Stream<
        ...
        async fn ingest(
            &self,
            request: tonic::Request<tonic::Streaming<super::IngestRequest>>,
        ) -> std::result::Result<tonic::Response<Self::IngestStream>, tonic::Status>;
    }
    #[derive(Debug)]
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/rat.observability.v1.ObservabilityService/Ingest" => {
                    ...
                    struct IngestSvc<T: ObservabilityService>(pub Arc<T>);
                    impl<
                        T: ObservabilityService,
                    > tonic::server::StreamingService<super::IngestRequest>
                    for IngestSvc<T> {
                        type Response = super::IngestResponse;
                        type ResponseStream = T::IngestStream;
                        ...
                        fn call(
                            ...
                            request: tonic::Request<
                                tonic::Streaming<super::IngestRequest>,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ObservabilityService>::ingest(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "rat.observability.v1.ObservabilityService";
