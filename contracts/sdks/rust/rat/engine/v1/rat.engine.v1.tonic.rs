...
pub mod engine_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("rat.engine.v1.EngineService", "Execute"));
        ...
        pub async fn query(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("rat.engine.v1.EngineService", "Query"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn preview(
            &mut self,
            request: impl tonic::IntoRequest<super::PreviewRequest>,
        ) -> std::result::Result<
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("rat.engine.v1.EngineService", "Preview"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod engine_service_server {
    ...
    pub trait EngineService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn preview(
            &self,
            request: tonic::Request<super::PreviewRequest>,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/rat.engine.v1.EngineService/Execute" => {
                    ...
                    struct ExecuteSvc<T: EngineService>(pub Arc<T>);
                    impl<
                        T: EngineService,
                    ...
                    for ExecuteSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as EngineService>::execute(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/rat.engine.v1.EngineService/Query" => {
                    #[allow(non_camel_case_types)]
                    struct QuerySvc<T: EngineService>(pub Arc<T>);
                    impl<
                        T: EngineService,
                    > tonic::server::UnaryService<super::QueryRequest> for QuerySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as EngineService>::query(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/rat.engine.v1.EngineService/Preview" => {
                    #[allow(non_camel_case_types)]
                    struct PreviewSvc<T: EngineService>(pub Arc<T>);
                    impl<
                        T: EngineService,
                    > tonic::server::UnaryService<super::PreviewRequest>
                    for PreviewSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as EngineService>::preview(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "rat.engine.v1.EngineService";
