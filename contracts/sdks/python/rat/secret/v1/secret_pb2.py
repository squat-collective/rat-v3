...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'ZKgithub.com/squat-collective/rat-v3/contracts/sdks/go/rat/secret/v1;secretv1'
