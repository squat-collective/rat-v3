...
def contribute_ui(gateway, caller, components, tenant="acme", retries=1, traceparent=None):
    ...
    components— a list of component-spec dicts, each with at least {slot, id, title}.
