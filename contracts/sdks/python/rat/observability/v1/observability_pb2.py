...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'ZKgithub.com/squat-collective/rat-v3/gen/rat/observability/v1;observabilityv1'
