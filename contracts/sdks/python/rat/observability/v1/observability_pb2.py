...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'ZYgithub.com/squat-collective/rat-v3/contracts/sdks/go/rat/observability/v1;observabilityv1'
