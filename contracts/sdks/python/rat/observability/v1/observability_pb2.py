...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'Z@github.com/le-squat/rat/gen/rat/observability/v1;observabilityv1'
