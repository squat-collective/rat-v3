...
## 2026-06-02 — Q02 kit extended: tailored SRE + ecosystem briefs

Two more lens-tailored companions (parallel to the security one), each front-loading a real-vs-paper section + a lens-specific question set so the reviewer models the right system.
...
**Q02 kit now (4 briefs + outreach):** [general](../reviews/Q02-external-review-brief.md) · [outreach note](../reviews/Q02-outreach-note.md) · tailored [security](../reviews/Q02-brief-security.md) / [SRE](../reviews/Q02-brief-sre.md) / [ecosystem](../reviews/Q02-brief-ecosystem.md). The two internal lenses without a tailored variant: contracts/architect ([reviews/01](../reviews/01-adversarial-architect.md), [06](../reviews/06-proto-contract-review.md)). Next: recruit reviewers + run it.
