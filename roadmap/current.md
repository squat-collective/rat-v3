...
6. **Add `core/v1/invoke.proto`** — the core-mediated capability-invoke service (ADR-005). The missing API-gateway contract; routes by capability URI, enforces C2/C3/C5/C7/C8 + stamps C1. ← **DO NEXT** — the core-mediated capability-invoke service (ADR-005). The missing API-gateway contract; routes by capability URI, enforces C2/C3/C5/C7/C8 + stamps C1.
