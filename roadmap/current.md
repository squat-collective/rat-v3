...
7. **Async event-bus envelope** (`common/v1/event.proto`: trace+correlation+tenant+event_id+dedup) OR explicitly carve the async plane out of the `rat/1` freeze. ← **DO NEXT**
