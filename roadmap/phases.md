...
| **4** | **Distribution + hardening** — the GHCR release pipeline, then GTM | **in-flight** (2026-06-03) | — | *Reordered:* ship rat as a `ghcr.io` binary + image (`curl … && chmod +x ./rat`) first; the GTM gaps follow. |
