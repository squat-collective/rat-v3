"""Entrypoint: serve DeploymentRuntimeService over gRPC. Address from $RAT_PLUGIN_ADDR
...
def serve() -> None:
    ...
    server.start()
    print(f"rat-deploymentruntime-local-process-py listening on 127.0.0.1:{port}", flush=True)
