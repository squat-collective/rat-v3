"""The CatalogService gRPC implementation (Python, DuckLake-backed).

Identical surface to the other catalog references (GetTable / RegisterTable /
CommitTable / CreateBranch / MergeBranch); only the store is DuckLake-backed.
CatalogError → the matching gRPC status via context.abort. RequestContext is NOT a
field (ADR-007); identity ignored.
"""
